import argparse
from models.multiDFR.anoseg_dfr import MultiScaleDFR
import os
...
if __name__ == "__main__":
    ...
    # train or evaluation
    cfg.data_name = 'bottle'
    cfg.train_data_path = r"D:\presonal\researchCode\DFR-skip-resnet\SensorAnoData\bottle\train\good"
    cfg.test_data_path = r"D:\presonal\researchCode\DFR-skip-resnet\SensorAnoData\bottle\test"

    dfr = MultiScaleDFR(cfg)
    if cfg.mode == "train":
        dfr.train()
    else:
