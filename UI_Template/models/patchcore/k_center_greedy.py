...
from models.patchcore.random_project import SparseRandomProjection
...
class KCenterGreedy:
    ...
    def __init__(self, embedding: Tensor, sampling_ratio: float, callback = None) -> None:
    ...
    def select_coreset_idxs(self, selected_idxs: Optional[List[int]] = None) -> List[int]:
        ...
        print("select coreset idxs...")
        for i in tqdm(range(self.coreset_size)):
            ...
            self.callback('',self.coreset_size)
